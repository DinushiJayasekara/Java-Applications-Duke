...
public class EarthQuakeClient2 {
    ...
    public void quakesWithFilter() { 
        ...
        Filter f1 = new DistanceFilter(1000, city); 
        ArrayList<QuakeEntry> list1  = filter(list, f1);
        ...
        System.out.println("Found "+list2.size()+" quakes that match the criteria");
        System.out.println("\nFilters used are: \n" + f1.getName());
    ...
    public void testMatchAllFilter() { 
        ...
        System.out.println("Found "+m7.size()+" quakes that match the criteria");
        System.out.println("\nFilters used are: \n" + maf.getName());
    }
